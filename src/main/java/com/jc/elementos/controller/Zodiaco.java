...
"Frase de la semana: Lo importante no es ganar. Lo que importa es competir, sin perder ni empatar ");
        Signo geminis=new Signo("geminis","De lunes a miércoles, su cabeza se llenará de nueva información, pero el jueves no se acordará de nada, entonces, se dará cuenta de que esta perdiendo la memoria, pero para el viernes ya no se hará problema porque olvidará que estaba perdiendo la memoria ¿se entendió? Yo les aconsejo a los geminianos que no presten dinero, porque no se acordarán ni cuanto ni a quien le prestaron. Otra cosa, si esta semana quiere aprovechar para estar con varias mujeres, le va a ir muy bien, porque se encuentra de ligue, únicamente tenga cuidado si está en pareja porque la va a ligar. ");
        Signo tauro=new Signo("tauro","Esta semana para Aries se torna bastante complicada, hay un problema que debe ser resuelto cuanto antes, sino la profe de matemáticas lo aplazará. Modifique su conducta agresiva hacia los demás, si no la puede modificar del todo alterne esa agresividad con amor, o sea, si alguien le cruza el auto, insúltelo, pínchele la rueda si quiere o rómpale el parabrisas con el matafuego, pero luego, pídale disculpas, déle un beso en la mejilla y dígale: “ ta` todo bien hermano”, si este responde con hostilidad, no diga nada, dese vuelta tranquilamente y en el momento que crea oportuno desármele el matafuego en la cabeza, para que aprenda a perdonar. \n" +
"\n" +
"Frase de la semana: Arreglar los problemas económicos es fácil, lo único que se necesita es dinero. ");
        Signo aries=new Signo("aries","Los días jueves y viernes sentirá como si un loro le hablara al oído, no se confunda, ese loro es, nada más y nada menos que su linda y tan venerada suegra, vendrá de visita y se quedará con usted un par de días, en lo posible, trate de no matarla. \n" +
"\n" +
"Frase de la semana: Morir es como dormir, pero sin levantarse a hacer pis. ");
        Signo escorpion=new Signo("escorpion","Esta semana algunos días estará bien y otros no tanto, aproveche los días que este bien para salir y divertirse, y los días que este mal no se deprima, salga y diviértase, o sea que si usted quiere puede estar de fiesta toda la semana. Tómese unas mini vacaciones, vaya a un mini golf y póngase una minifalda. \n" +
"\n" +
"El jueves comienza a sentir que necesita una señal para saber si está con la persona correcta, y entonces ve un cartel en la ruta que dice: “Si, estás con la persona correcta” y se queda tranquilo. Pero luego piensa: “esto es cosa e` mandinga”. Y si, puede ser, quien sabe. \n" +
"\n" +
"Frase para la semana: Si quieres una mano que te ayude, la encontraras al final de tu brazo. ");
    ...
    public String leerFuturo(String parametro) {
      String tuFuturo="Tu signo no estÃ¡ disponible :(";
      for(Signo s:signos){
